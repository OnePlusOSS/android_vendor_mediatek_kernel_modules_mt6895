...
uint32_t g_tau_base 	= TAU_BASE;

void timing_init(int speed)
{
	g_tau_base					= speed;
	g_ulBaudLow 				= 10*speed;		//1 * tau;
	g_ulBaudHigh 				= 30*speed;		//3 * tau;
	g_ulBaudStop				= 50*speed;		//5 * tau;
	g_ulResponseTimeOut 			= 200*speed;		//10 * tau;
...
void Set_SWIHighSpeed(void) {
	g_ulBaudLow 				= 10*TAU_BASE;		//1 * tau;
	g_ulBaudHigh 				= 30*TAU_BASE;		//3 * tau;
	g_ulBaudStop				= 50*TAU_BASE;		//5 * tau;
	g_ulResponseTimeOut 			= 200*TAU_BASE;		//10 * tau;
