...
static void oplus_chg_print_debug_info(struct oplus_chg_chip *chip)
{
		...
		oplus_chg_debug_notify_flag_is_set(OPLUS_NOTIFY_CHARGER_INFO))
	{
		...
		if (pps_chip && pps_chip->pps_support_type) {
			ret += snprintf(&oplus_chg_debug_msg[ret], OPLUS_CHG_DEBUG_MSG_LEN - ret,
					"PPS_MSG[%d, %d, %d, %d, %d, %d][%d, %d, %d, %d, %d, %d, %d][%d, %d, %d, %d, %d][%d, %d, %d, %d, %d, %d, %d, %d]\
					...
					pps_chip->current_batt_curve, pps_chip->current_batt_temp, pps_chip->current_cool_down, pps_chip->cp_ibus_down, pps_chip->cp_r_down,
					...
					pps_chip->ap_input_volt, pps_chip->ap_input_current, pps_chip->cp_master_ibus, pps_chip->cp_master_vac, pps_chip->cp_master_vout,
					pps_chip->cp_slave_vout, pps_chip->cp_slave_vac, pps_chip->cp_slave_ibus, pps_chip->slave_input_volt,
