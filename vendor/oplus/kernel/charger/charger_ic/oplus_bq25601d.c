...
#elif defined(CONFIG_OPLUS_CHARGER_MTK6763) || defined(CONFIG_OPLUS_CHARGER_MTK6771) ||defined(CONFIG_OPLUS_CHARGER_MTK6833)
#include <linux/module.h>
...
{
#ifdef CONFIG_OPLUS_CHARGER_MTK
#if defined(CONFIG_OPLUS_CHARGER_MTK6763) || defined(CONFIG_OPLUS_CHARGER_MTK6771) || defined(CONFIG_OPLUS_CHARGER_MTK6873) || defined(CONFIG_OPLUS_CHARGER_MTK6833)
	int ret = 0;
	int retry = 3;
	if (!charger_ic) {
...
/* wanglin.chen@BSP.CHG.Basic, 2021/02/23, set 9V ovp voltage */
	rc = bq25601d_config_interface(chip, REG06_BQ25601D_ADDRESS,
...
#ifdef OPLUS_FEATURE_CHG_BASIC
/*wanglin.chen@BSP.CHG.Basic, 2020/10/27, add for setting reg0's input current limit of bq25601d*/
	msleep(300);
#endif
	return rc;
}

#if defined (CONFIG_MTK_PMIC_CHIP_MT6353) || defined(CONFIG_OPLUS_CHARGER_MTK6763) || defined(CONFIG_OPLUS_CHARGER_MTK6771) || defined(CONFIG_OPLUS_CHARGER_MTK6873) || defined(CONFIG_OPLUS_CHARGER_MTK6833)
