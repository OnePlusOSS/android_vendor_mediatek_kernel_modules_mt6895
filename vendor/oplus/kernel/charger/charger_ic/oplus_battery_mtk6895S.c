...
/*LiYue@BSP.CHG.Basic, 2021/10/06, add for charger*/
#include "mtk_battery.h"
#endif

#ifdef OPLUS_FEATURE_CHG_BASIC /*Fanhong.Kong@BSP.CHG.Basic, 2021/09/10, Add for pps charging*/
...
/*LiYue@BSP.CHG.Basic, 2021/05/12, add for charger*/
...
#ifndef OPLUS_FEATURE_CHG_BASIC
/*LiYue@BSP.CHG.Basic, 2021/06/29, Modify for charging*/
...
#ifndef OPLUS_FEATURE_CHG_BASIC
/*LiYue@BSP.CHG.Basic, 2021/05/12, add for charge*/
...
#ifndef OPLUS_FEATURE_CHG_BASIC
/*LiYue@BSP.CHG.Basic, 2021/10/18, add for get chargeic temperature*/
...
static void mtk_charger_external_power_changed(struct power_supply *psy)
{
	...
	struct power_supply *chg_psy = NULL;
#ifdef OPLUS_FEATURE_CHG_BASIC
/*LiYue@BSP.CHG.Basic, 2021/06/29, add for charge*/
...
#ifdef OPLUS_FEATURE_CHG_BASIC
/* ZhangKun@BSP.CHG.Basic, 2021/12/23, sjc Add for charging */
//====================================================================//
...
#ifdef OPLUS_FEATURE_CHG_BASIC
/* LiYue@BSP.CHG.Basic, 2021/05/12, Add for charging */
...
#ifdef OPLUS_FEATURE_CHG_BASIC
/*Boyu.Wen@BSP.CHG.Basic, 2021/08/10, Add for chargeric temp */
...
bool oplus_usbtemp_check_is_platpmic(struct oplus_chg_chip *chip)
{
	...
	return chip->usbtemp_dischg_by_platpmic;
}
...
#endif
#ifdef OPLUS_FEATURE_CHG_BASIC /*Fanhong.Kong@BSP.CHG.Basic, 2021/07/30, Add for pps  charging*/
	init_pps_key();
#endif
	return 0;
}
...
#ifdef OPLUS_FEATURE_CHG_BASIC
/* LiYue@BSP.CHG.Basic, 2021/05/12, Add for shipmode stm6620 */
	if (g_oplus_chip) {
