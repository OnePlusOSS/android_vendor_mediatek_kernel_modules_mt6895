...
typedef struct Netlink__Proto__RequestSetGameMainStreamUid Netlink__Proto__RequestSetGameMainStreamUid;
...
typedef struct Netlink__Proto__NotifyGameMainServerIp Netlink__Proto__NotifyGameMainServerIp;
...
typedef enum _Netlink__Proto__NetlinkMsgId {
  ...
  NETLINK__PROTO__NETLINK_MSG_ID__COMM_NETLINK_EVENT_NOTIFY_GAME_MAIN_IP = 201,
  NETLINK__PROTO__NETLINK_MSG_ID__COMM_NETLINK_EVENT_SET_GAME_UID = 202
...
struct  Netlink__Proto__RequestSetGameMainStreamUid
{
  ProtobufCMessage base;
  size_t n_gameuid;
  uint32_t *gameuid;
};
#define NETLINK__PROTO__REQUEST_SET_GAME_MAIN_STREAM_UID__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&netlink__proto__request_set_game_main_stream_uid__descriptor) \
    , 0,NULL }
...
typedef enum {
  ...
  NETLINK__PROTO__REQUEST_MESSAGE__REQUEST_DATA_REQUEST_SET_GAME_MAIN_STREAM_UID = 16
...
struct  Netlink__Proto__RequestMessage
{
  ...
  union {
    ...
    Netlink__Proto__RequestSetGameMainStreamUid *requestsetgamemainstreamuid;
  };
};
...
struct  Netlink__Proto__NotifyGameMainServerIp
{
  ProtobufCMessage base;
  uint32_t battleip;
  uint32_t gameuid;
};
#define NETLINK__PROTO__NOTIFY_GAME_MAIN_SERVER_IP__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&netlink__proto__notify_game_main_server_ip__descriptor) \
    , 0, 0 }
...
typedef enum {
  ...
  NETLINK__PROTO__NOTIFY_MESSAGE__NOTIFY_DATA_NOTIFY_GAME_MAIN_SERVER_IP = 12
...
struct  Netlink__Proto__NotifyMessage
{
  ...
  union {
    ...
    Netlink__Proto__NotifyGameMainServerIp *notifygamemainserverip;
  };
};
...
void   netlink__proto__request_set_dpi_uid__free_unpacked
                     (Netlink__Proto__RequestSetDpiUid *message,
                      ProtobufCAllocator *allocator);
/* Netlink__Proto__RequestSetGameMainStreamUid methods */
...
void   netlink__proto__notify_wzry_server_ip__free_unpacked
                     (Netlink__Proto__NotifyWzryServerIp *message,
                      ProtobufCAllocator *allocator);
/* Netlink__Proto__NotifyGameMainServerIp methods */
...
typedef void (*Netlink__Proto__RequestSetDpiUid_Closure)
                 (const Netlink__Proto__RequestSetDpiUid *message,
                  void *closure_data);
typedef void (*Netlink__Proto__RequestSetGameMainStreamUid_Closure)
                 (const Netlink__Proto__RequestSetGameMainStreamUid *message,
                  void *closure_data);
...
typedef void (*Netlink__Proto__NotifyWzryServerIp_Closure)
                 (const Netlink__Proto__NotifyWzryServerIp *message,
                  void *closure_data);
typedef void (*Netlink__Proto__NotifyGameMainServerIp_Closure)
                 (const Netlink__Proto__NotifyGameMainServerIp *message,
                  void *closure_data);
...
extern const ProtobufCMessageDescriptor netlink__proto__request_set_game_main_stream_uid__descriptor;
...
extern const ProtobufCMessageDescriptor netlink__proto__notify_game_main_server_ip__descriptor;
